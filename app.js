...
// Váriavel que pega o botão no mundo HTML
const btn = document.getElementById("btn");

// Váriavels que pega o elemento dentro de Span
const color = document.querySelector(".color");



// Criação do evento para quando receber o click, mudar a cor de fundo.
btn.addEventListener("click", () => {

    // Váriavel da função getRandomNumber para fácilitar a utilização da função
    const randomNumber = getRandomNumber();

    //  Acessando o style "background color" e introduzindo o valor sorteado pelo randomNumber como cor do background.
    document.body.style.backgroundColor = colors[randomNumber];

    // Recebendo o valor sorteado pelo randomNumber e adicionando como conteúdo do color que é o span para sabermos qual é o número da cor.
...
// Função para sortear e retornar um número de acordo com o tamanho da lista de cores
getRandomNumber = () => {
